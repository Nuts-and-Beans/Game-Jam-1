...
public class Blit : ScriptableRendererFeature {
    ...
    public class BlitPass : ScriptableRenderPass {
        ...
        public override void Execute(ScriptableRenderContext context, ref RenderingData data) {
            ...
            if (settings.setInverseViewMatrix) {
                Shader.SetGlobalMatrix("_InverseView", data.cameraData.camera.cameraToWorldMatrix);
            }
...
#if UNITY_EDITOR
        if (data.cameraData.isSceneViewCamera) return;
#endif
    ...
    if (settings.Event == RenderPassEvent.AfterRenderingPostProcessing) {
    } else if (settings.Event == RenderPassEvent.AfterRendering && data.postProcessingEnabled) {
